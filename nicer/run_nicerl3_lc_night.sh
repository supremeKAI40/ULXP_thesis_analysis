...
do
    nicerl3-lc indir="$folder" clfile='$CLDIR/ni$OBSID_0mpu7_cl_night_barycorr.evt' pirange=80-1200 clobber=yes timebin=0.00025 suffix=_night 2>&1 | tee "$folder/${folder}_night_lc.log"
done
